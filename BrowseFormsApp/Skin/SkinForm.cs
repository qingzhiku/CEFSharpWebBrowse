...
namespace BrowseForms
{
    ...
    partial class SkinForm : Form
    {
        ...
        public void SetBits() {
            ...
            ImageDrawRect.DrawRect(g, RockerBrowseForms.Properties.Resources.main_light_bkg_top123, ClientRectangle, Rectangle.FromLTRB(_BacklightLTRB.X, _BacklightLTRB.Y, _BacklightLTRB.Width, _BacklightLTRB.Height), 1, 1);
